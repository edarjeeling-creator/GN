-- ==============================================================================
-- Migration: 20260923_allow_delete_notices.sql
-- Enables Principal and Admin to delete notices/messages, author to delete own notices,
-- and creates an RPC delete_school_notice for resilient execution.
-- ==============================================================================
