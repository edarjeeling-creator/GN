...
BEGIN
  -- 1. Derive identity strictly from auth context (No spoofing possible)
  ...
  -- 4. Authoritative Campus Resolution Hierarchy
  ...
  -- 6. Geolocation & Accuracy Validation
  ...
  -- 8. State Machine & Status Enforcement
  ...
  -- 9. Invalidate consumed QR session token immediately
