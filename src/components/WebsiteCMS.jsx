        ...
        <>
          ...
          <div className="bento-card" style={{ padding: '2rem', gridColumn: '1 / -1' }}>
            ...
            <form onSubmit={saveLeadershipMessage} style={{ display: 'grid', gap: '1rem' }}>
              ...
              <label style={{ fontSize: '0.875rem', fontWeight: 600 }}>Image URL: <input type="url" className="input-field" style={{ width: '100%', marginTop: '0.25rem', background: '#f8fafc', color: '#0f172a' }} value={leadershipMessage.imageUrl} onChange={e => setLeadershipMessage({...leadershipMessage, imageUrl: e.target.value})} /></label>
